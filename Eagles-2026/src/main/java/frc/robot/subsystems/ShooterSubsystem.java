...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private void configureHood() {
    ...
    double degPerPulse =
        (360.0 / kHoodEncoderPulsesPerRev) / kHoodEncoderToHoodGearRatio;
  ...
  public void setHoodForDistanceMeters(Supplier<Pose2d> getRobotPose, Supplier<Boolean> isRed) {
    setHoodAngleDeg(m_hoodAngleByDistance.get(TurretAimMath.solveForBasket(getRobotPose.get(), isRed.get()).distanceMeters()));
  }
